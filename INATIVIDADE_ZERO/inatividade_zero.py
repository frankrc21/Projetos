...
texto = ctk.CTkLabel(janela, text="INATIVIDADE ZERO", font=("Futura Md BT", 16, "bold"), text_color="white")
...
def impedir_inatividade():
    while True:
        if inatividade_ativa:
            pyautogui.press('scrolllock')  # Pressiona a tecla 'Shift'
        time.sleep(115)  # Espera 1 minuto e 55 segundos
